...
export namespace RtcTokenBuilder {
     ...
     */
    export function buildTokenWithAccount(appID: string, appCertificate: string, channelName: string, account: string, role: number, token_expire:number, privilege_expire: number): string;
}
