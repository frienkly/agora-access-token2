...
export namespace RtcRole {
    ...
    export const AUDIO_ONLY_PUBLISHER: number;
}
...
export namespace RtcTokenBuilder {
     ...
     * - Role.AUDIO_ONLY_PUBLISHER; Use this role for a voice call or a live broadcast.
     ...
     */
    export function buildTokenWithUid(appID: string, appCertificate: string, channelName: string, uid: number, role: number, token_expire:number, privilege_expire: number): string;
     ...
     */
    export function buildTokenWithUserAccount(appID: string, appCertificate: string, channelName: string, account: string, role: number, token_expire:number, privilege_expire: number): string;
}
